# If you wish to adjust the weights that the algorithm places on each type of communication that can be done through the Edit Weights tab in the Settings menu.
